...
assignment = import_notebook_module('../notebooks/Data_Preprocessing.ipynb')

def test_train_model():
    assignment.load_dataset()
    assignment.handeling_identified()
    assignment.encodeed()
    assignment.scale_features('normalize')
    assignment.scale_features('standarize')
